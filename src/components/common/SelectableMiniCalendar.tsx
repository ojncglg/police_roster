...
interface SelectableMiniCalendarProps {
  selectedDates: Date[];
  onSelectDate: (date: Date) => void;
  className?: string;
}

const SelectableMiniCalendar = ({ selectedDates, onSelectDate, className = '' }: SelectableMiniCalendarProps) => {
        ...
        {calendarDays.map((day, index) => (
          <button
            ...
            className={`
              ...
              ${day.isSelected ? 'ring-2 ring-police-yellow bg-police-yellow/20' : ''}
...
export default SelectableMiniCalendar;
